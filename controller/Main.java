...
public class Main extends Application{
    ...
    //Open Tour Window
    public void tourWindow(){

         try {

             FXMLLoader tourLoader = new FXMLLoader(Main.class.getResource("/view/TourView.fxml"));
             AnchorPane tourPane = tourLoader.load();

             TourController tourController = tourLoader.getController();
             Scene tourScene = new Scene(tourPane);
             Stage secondaryStage = new Stage();

             tourController.setTourView(this);

             secondaryStage.initOwner(primaryStage);
             secondaryStage.initModality(Modality.APPLICATION_MODAL);
             secondaryStage.setTitle("Tours");
             secondaryStage.getIcons().add(new Image("/view/Icons/tourIcon.png"));
             secondaryStage.setScene(tourScene);
             secondaryStage.show();
